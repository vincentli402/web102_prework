...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        gameCard.innerHTML = `
            <img src="${games[i].img}" alt="${games[i].name}" style="max-width: 100%;" />
            <h2>${games[i].name}</h2>
...
const descriptionString = `
    A total of $${totalPledged.toLocaleString()} has been raised for ${totalGames.toLocaleString()} games. Currently, 
    ${unfundedGamesCount} game${unfundedGamesCount === 1 ? '' : 's'} remain unfunded. We need your help to fund these amazing games!
`;
